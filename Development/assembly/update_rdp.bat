REM ==============================================================================================
REM ==============================================================================================
REM ===яйпхор пюгбепршбюмхъ декэрш дхярпхасрхбю мю йкхемряйнл ндхмнвмнл яепбепе я ндмхл опнейрнл вепег RDP-ондйкчвемхе
REM ==============================================================================================
REM ==============================================================================================
...
REM ==============================================================================================
REM ===акнй оепелеммшу япедш йнлоэчрепю пюгпюанрвхйю==============================================
REM ==============================================================================================
SET DEVELOPER_DISTR_PATH=\\tsclient\D\WorkflowTechnology\Clients\NorthernRay
SET DEVELOPER_CLOUD_REPOSITORY_PATH=\\tsclient\D\YandexDisk\нАМНБКЕМХЪ\яЕБЕПМШИ кСВ
...
REM ===щрюо 2. онксвемхе декэрш дхярпхасрхбю======================================================

REM ==============================================================================================
REM ===онксвемхе декэрш дхярпхасрхбю я йнлоэчрепю пюгпюанрвхйю====================================
REM ==============================================================================================
...
IF EXIST "%CLIENT_DISTR_PATH%\_update\Database\update.txt" (
    ...
    REM ===оепехлемнбюмхе тюикю я намнбкемхел аюгш дюммшу б оюойе пюгпюанрвхйю====================
    ...
    REM ===нропюбйю пегепбмни йнохх аюгш дюммшу оняке намнбкемхъ мю йнлоэчреп пюгпюанрвхйю========
...
REM ===щрюо 9. сярюмнбйю нрлернй на сяоеьмнл намнбкемхх мю йнлоэчрепе пюгпюанрвхйю================

REM ==============================================================================================
REM ===оепехлемнбюмхе дхярпхасрхбю б пеонгхрнпхх мю йнлоэчрепе пюгпюанрвхйю=======================
REM ==============================================================================================
SET DATE_STAMP_SUFFIX=empty
...
REM ===щрюо 10. сдюкемхе бпелеммшу тюикнб х оюонй==================================================
